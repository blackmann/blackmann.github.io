      ...
      <ul
        ...
        {outline.map((chapter) => (
          <li key={chapter.slug}>
            <a
              className={clsx(
                'text-secondary dark:hover:(bg-neutral-700 bg-opacity-40) flex justify-between rounded-lg px-2 py-1 no-underline hover:bg-zinc-200 lg:dark:hover:bg-neutral-800',
                {
