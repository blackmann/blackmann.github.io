...
You'll notice that, if the circle went gradually, it'll cause contrasting issues with the text. For accessibility reasons, it makes sense the circle behaves as done on the GSAP website.
