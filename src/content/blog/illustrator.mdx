...
Last night, while preparing my notes on [Vectors](/lesson-notes/vectors-i), I needed to do some illustrations. The immediate option was to use code to draw them. I had seen this [library](https://roughjs.com) and wanted to use it because it made the lines look hand-drawn; the perfect aesthetic I was look for.
...
<video class="mb-4" src="/draw.mp4" autoplay loop/>
